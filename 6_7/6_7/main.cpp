...
int main()
{
	...
	switch( Str1.compare(Str2) )
	{
		...
		case 1 :	cout << "Str1 more Str2" << endl; break;
		case -1 :	cout << "Str1 less Str2" << endl; break;
	}
	cout << "Now find 's' in Str3." << endl;
	int pos = Str3.find("s");
	if (pos > -1)
		cout << "founf 's' in Str3 at position " << pos << endl;
	else
		cout << "not found 's' in Str3." << endl;
	Str2.erase(5,4);
	cout << "After replace character to Str2 : " << Str2 << endl;
